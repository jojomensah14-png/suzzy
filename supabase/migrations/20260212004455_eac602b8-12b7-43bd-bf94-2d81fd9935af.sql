...
CREATE TABLE public.profiles (
  ...
  skin_type TEXT DEFAULT '' CHECK (skin_type IN ('', 'oily', 'dry', 'combination', 'acne-prone', 'sensitive', 'normal')),
  skin_tone TEXT DEFAULT '' CHECK (skin_tone IN ('', 'light', 'medium', 'dark', 'deep')),
...
CREATE TABLE public.chat_sessions (
  ...
  title TEXT DEFAULT 'Beauty Session',
  created_at TIMESTAMPTZ NOT NULL DEFAULT now(),
  updated_at TIMESTAMPTZ NOT NULL DEFAULT now()
);
